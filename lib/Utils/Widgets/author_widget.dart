...
class AuthorWidget extends GetView<ReaderDashboardController> {
  const AuthorWidget({
    Key? key,
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return GridView.builder(
        itemCount: controller.authorNameList.length,
      ...
      onTap: () => Get.toNamed(Routes.authorDetailsScreen),
      child: PhysicalModel(
            ...
            Expanded(
              ...
              child: Center(
                child: Column(
                  ...
                  children: [
                    CustomWidget.text(controller.authorNameList[index],
