...
class CustomWidget {
  ...
  static customAssetSVGImageWidget(
      {String? image,
      double height = 4.0,
      double width = 4.0,
      BoxFit fit = BoxFit.contain}) {
  ...
  static BoxDecoration customBoxDecoration({
    ...
    return BoxDecoration(
        ...
        boxShadow: [BoxShadow(color: Colors.grey.withOpacity(0.1),blurRadius: 5,spreadRadius: 2,offset: Offset(0,2))],
  ...
  static InputDecoration customInputDecoration(
      ...
      EdgeInsets contentPadding =
          const EdgeInsets.only(top: 15, bottom: 15, right: 0,left: 10),
      String? suffixIcon}) {
  ...
  /// Custom Input Decoration it's used all over the app for TextField
  ///
  static InputDecoration customInputDecorationIcon({
    required String hintText,
    bool? isSufixShow = false,
    bool? isPrefixShow = false,
    String? prefixImage,
    ...
    return Column(
      ...
      children: [
        CustomWidget.text(headingText!,
            fontSize: 12.0, color: AppColor.darkGrey),
  ...
  static ThemeData dateTimePickerThemeData() {
    return ThemeData.light().copyWith(
      colorScheme: const ColorScheme.light(
          primary: AppColor.primaryColor, onSurface: AppColor.darkGrey),
